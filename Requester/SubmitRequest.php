...
if(isset($_REQUEST['submitrequest'])) {
  ...
  if(($_REQUEST['requestinfo'] == "") ||
    ...
    $sql = "INSERT INTO submitrequest_tb"
          ."(request_info, request_desc, requester_name, requester_add1, requester_add2, requester_city,"
          ."requester_state, requester_zip, requester_email, requester_mobile, request_date)"
